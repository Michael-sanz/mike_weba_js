...
# class SGPC_PROVIENT(models.Model):
#     service_id = models.ForeignKey(SGPC_SERVICE, on_delete=models.CASCADE)
#     reservation_id = models.ForeignKey(SGPC_RESERVATION, on_delete=models.CASCADE)
...
# class FAIT_REFERENCE_A(models.Model):
#     devis = models.ForeignKey(SGPC_DEVIS, on_delete=models.CASCADE)
#     reservation = models.ForeignKey(SGPC_RESERVATION, on_delete=models.CASCADE)

# class EST_ASSOCIE_A(models.Model):
#     reservation = models.ForeignKey(SGPC_RESERVATION, on_delete=models.CASCADE)
#     commande = models.ForeignKey('catalogue.SGPC_COMMANDE', on_delete=models.CASCADE)